    ...
    <>
      <style>{`
        ...
        .ai-container {
          ...
          margin: 0 auto;
          padding: 48px 24px;
          margin-top: 50px; /* Avoid navbar congestion */
        ...
        .back-btn:hover {
          ...
          box-shadow: 0 6px 16px hsla(174 62% 47% / 0.3);
        }
        .ai-card {
          background: white;
          border-radius: 16px;
          ...
          padding: 32px;
          border-left: 4px solid hsl(174 62% 47%);
        }
      ...
      <div className="ai-page">
        ...
        <div className="ai-container">
          <div className="ai-header">
            <div>
              <h1>🧴 SkinCare AI Analysis</h1>
              <p>Analyze patient’s skin condition using AI diagnostics</p>
            </div>
          ...
          <div className="ai-card">
            ...
            {imageUrl ? (
              <>
                {/* ⭐ IMAGE CENTERED — ONLY ONCE */}
                <div className="ai-image-wrapper">
                  <img src={imageUrl} alt="Patient" className="ai-image" />
                </div>

                {/* AI Processing Component — unchanged */}
                <AIImageAnalysis
                  conditionType="skin"
                  imageUrl={imageUrl}
                  patientRef={ref}
