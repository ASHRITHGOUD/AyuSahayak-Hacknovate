...
/* =====================================================
   🌾 RURALCARE AI — PREMIUM MEDICAL CARD UI
===================================================== */
...
/* ============================================
   🌾 RuralCare Summary Pretty Layout
============================================ */
.rural-summary-container {
  margin-top: 16px;
  background: #f8fafc;
  padding: 18px;
  border-radius: 14px;
...
.btn-primary {
  background: linear-gradient(135deg, #6f4dcf, #7740d6);
  color: white;
}
...
@media (max-width: 600px) {
  ...
  .patient-avatar-large { width: 80px; height: 80px; }
/* ---------------- AI SUMMARY IMPROVED ---------------- */
.ai-summary-card {
  margin-top: 26px;
}
...
.report-box {
  ...
  border-radius: 6px;     /* SMALLER CORNER */
  font-size: 14px;
  line-height: 1.4;       /* TIGHTER LINE GAP */
...
{data.ruralCases.map((caseItem, index) => (
  <div key={index} className="rural-box">
    ...
    {/* Header */}
<div className="rural-header">
  <span className={`rural-chip rural-chip-${caseItem.classification}`}>
    ...
    {/* Basic Fields */}
    <div className="rural-info-row">
      <div className="rural-label">Symptoms</div>
      <div className="rural-value">{caseItem.symptoms?.join(", ")}</div>
    </div>

    <div className="rural-info-row">
      <div className="rural-label">Specialists</div>
      <div className="rural-value">{caseItem.specialists?.join(", ")}</div>
    </div>

    {/* Summary */}
   <div className="rural-summary-container">

  {/* CONDITION SUMMARY */}
  <div className="summary-section">
    <div className="summary-title">Condition Summary</div>
  ...
  {/* POSSIBLE CAUSES */}
  <div className="summary-section">
    <div className="summary-title">Possible Causes</div>
    <div className="summary-text">
  ...
  {/* NURSE ACTIONS */}
  <div className="summary-section">
    <div className="summary-title">Nurse Actions</div>
  ...
  {/* ESCALATION CRITERIA */}
  <div className="summary-section">
    <div className="summary-title">Escalation Criteria</div>
    <div className="summary-list">
      <ul>
  ...
  {/* MEDICINES */}
  <div className="summary-section">
    <div className="summary-title">Medicines Advised</div>
    <div>
      {caseItem.summary["MEDICINES ADVISED"].map((m, i) => (
        <span key={i} className="medicine-pill">{m}</span>
      ))}
    </div>
  </div>
    ...
    {["skinCareAI", "woundCareAI"].map((key) => {
      ...
      return (
        ...
        >
          ...
          {/* 🔹 FINAL AI REPORT  (with ReactMarkdown formatting) */}
          {ai.aiFinalReport && (
            <div className="final-report-area">
              <div className="section-label">🧾 Final Clinical Report</div>
              <div className="report-box markdown-body">
